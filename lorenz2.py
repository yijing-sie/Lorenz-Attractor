...
fig = plt.figure(facecolor='k', figsize=(15, 10))
...
ax.plot(x, y, z, color= 'black', linewidth = 0.5 , label = title1)
ax.plot(x2, y2, z2, color= 'red', linewidth = 0.4, label = title2)
...
plt.savefig('lorenz2.png', dpi=750)
plt.show()
